  ...
  void handleSubmit() async {
    ...
    if(stateSelection == null){
      ...
      formKey.currentState.save();
        ...
        openDialog(context, 'Eres un Tester', 'Solo los admin pueden subir, borrar y modificar contenido');
      } else {
    ...
    return Scaffold(
      ...
      body: Form(
            ...
            child: ListView(children: <Widget>[
              ...
              Text('Detalles del lugar', style: TextStyle(
              ...
              SizedBox(height: 20,),
              TextFormField(
                decoration: inputDecoration('Ingrese nombre del lugar', 'Nombre del lugar', nameCtrl),
                controller: nameCtrl,
                validator: (value){
                  if(value.isEmpty) return 'El valor está vacío'; return null;
                },

              ),
              SizedBox(height: 20,),
              TextFormField(
                decoration: inputDecoration('Ingrese nombre del sitio', 'Nombre del sitio', locationCtrl),
              ...
              Row(
                children: <Widget>[
                  Expanded(
                child: TextFormField(
                decoration: inputDecoration('Ingrese la latitud', 'Latitud', latCtrl),
                controller: latCtrl,
              ...
              Expanded(
                            child: TextFormField(
                  decoration: inputDecoration('Ingrese la longitud', 'Longitud', lngCtrl),
                  keyboardType: TextInputType.number,
              ...
              TextFormField(
                decoration: inputDecoration('Ingrese image url (thumbnail)', 'Image1(Thumbnail)', image1Ctrl),
              ...
              SizedBox(height: 20,),
              TextFormField(
                decoration: inputDecoration('Ingrese image url', 'Image2', image2Ctrl),
              ...
              SizedBox(height: 50,),
              Text('Guía de viaje detalles', style: TextStyle(
                fontSize: 30, fontWeight: FontWeight.w800
              ),),
              SizedBox(height: 20,),
              ...
              Expanded(
                            child: TextFormField(
                  decoration: inputDecoration('Ingrese nombre del destino', 'Nombre del destino', endpointNameCtrl),
              ...
              SizedBox(height: 20,),
              TextFormField(
                  decoration: inputDecoration('Ingrese precio', 'Precio', priceCtrl),
                  keyboardType: TextInputType.number,
              ...
              SizedBox(height: 20,),
              TextFormField(
                decoration: inputDecoration('Ingrese precio con la app', 'Precio con la app', priceByAppCtrl),
              ...
              Row(
                children: <Widget>[
                  Expanded(
                                    child: TextFormField(
                decoration: inputDecoration('Ingrese latitud del destino', 'Latitud del destino', endpointLatCtrl),
              ...
              Expanded(
                  child: TextFormField(
                  decoration: inputDecoration('Ingrese longitud del destino', 'Longitud del destino', endpointLngCtrl),
                  keyboardType: TextInputType.number,
                  ...
                  Row(
                      ...
                      children: <Widget>[
                        FlatButton.icon(
                          ...
                          label: Text('Vista previa', style: TextStyle(
