    ...
    return Scaffold(
      ...
      body: CoverWidget(
              ...
              child: ListView(children: <Widget>[
                ...
                SizedBox(height: 20,),
                TextFormField(
                  decoration: inputDecoration('Ingrese nombre del lugar', 'Ingrese nombre del lugar', nameCtrl),
                  controller: nameCtrl,
                  validator: (value){
                ...
                SizedBox(height: 20,),
                TextFormField(
                  decoration: inputDecoration('Ingrese localización del lugar', 'Nombre del Lugar', locationCtrl),
                ...
                Row(
                  children: <Widget>[
                    Expanded(
                  child: TextFormField(
                  decoration: inputDecoration('Ingrese Latitud', 'Latitud', latCtrl),
                  controller: latCtrl,
                ...
                Expanded(
                              child: TextFormField(
                    decoration: inputDecoration('Ingrese Longitud', 'Longitud', lngCtrl),
                    keyboardType: TextInputType.number,
                ...
                TextFormField(
                  decoration: InputDecoration(
                    hintText: 'Ingrese detalles del lugar (Html o Texto)',
                ...
                SizedBox(height: 50,),
                Text('Guá de viaje detalles', style: TextStyle(
                  fontSize: 30, fontWeight: FontWeight.w800
                ),),
                SizedBox(height: 20,),
                ...
                SizedBox(height: 20,),
                TextFormField(
                    decoration: inputDecoration('Ingrese precio del lugar', 'Precio', priceCtrl),
                    keyboardType: TextInputType.number,
                ...
                SizedBox(height: 20,),
                TextFormField(
                  decoration: inputDecoration('Ingrese precio con la app', 'Precio con la app', priceByApp),
                ...
                Row(
                  children: <Widget>[
                    Expanded(
                                      child: TextFormField(
                  decoration: inputDecoration('Ingrese latitud del destino', 'Destino latitud', endpointLatCtrl),
