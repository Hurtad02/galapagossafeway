            ...
            children: <Widget>[
              ...
              FutureBuilder(
                ...
                builder: (BuildContext context, AsyncSnapshot snap) {
                  if (!snap.hasData) return card('USUARIOS TOTALES', 0);
                  if (snap.hasError) return card('USUARIOS TOTALES', 0);
                  return card('USUARIOS TOTALES', snap.data);
                },
              ),
              SizedBox(
                width: 20,
              ...
              FutureBuilder(
                future: places,
                builder: (BuildContext context, AsyncSnapshot snap) {
                  if (!snap.hasData) return card('TOTAL DE SITIOS', 0);
                  if (snap.hasError) return card('TOTAL DE SITIOS', 0);
                  return card('TOTAL DE SITIOS', snap.data);
                },
              ),
              SizedBox(
                width: 20,
          ...
          Row(
            ...
            children: <Widget>[
              FutureBuilder(
                future: notifications,
                builder: (BuildContext context, AsyncSnapshot snap) {
                  if (!snap.hasData) return card('TOTAL NOTIFICACIONES', 0);
                  if (snap.hasError) return card('TOTAL NOTIFICACIONES', 0);
                  return card('TOTAL NOTIFICACIONES', snap.data);
                },
              ),
              ...
              StreamBuilder(
                ...
                builder: (context, AsyncSnapshot snap) {
                  if (!snap.hasData) return card('ITEM DESTACADO', 0);
                  if (snap.hasError) return card('ITEM DESTACADO', 0);
                  return card(
                      'ITEM DESTACADO', snap.data['places'].length);
                },
              ),
              ...
              FutureBuilder(
                future: states,
                builder: (BuildContext context, AsyncSnapshot snap) {
                  if (!snap.hasData) return card('TOTAL ESTADOS', 0);
                  if (snap.hasError) return card('TOTAL ESTADOS', 0);
                  return card('TOTAL ESTADOS', snap.data);
                },
              ),
            ],
          ),
