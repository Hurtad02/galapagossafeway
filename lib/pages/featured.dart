...
class _FeaturedPlacesState extends State<FeaturedPlaces> {
  ...
  Future<Null> _getData() async {
    ...
    if (data != null && data.docs.length > 0) {
      ...
      openToast(context, 'No hay más contenido disponible');
    }
    return null;
        ...
        builder: (BuildContext context) {
          return SimpleDialog(
            ...
            children: <Widget>[
              ...
              Text('Quieres remover este sitio de la lista de destacados?',
                  style: TextStyle(
                  ...
                  FlatButton(
                    ...
                    onPressed: () async {
                      if (ab.userType == 'tester') {
                        ...
                        openDialog(context, 'Eres un Tester', 'Solo los admin pueden hacer esto');
                      } else {
                    ...
                    children: <Widget>[
                      ...
                      Container(
                        ...
                        child: FlatButton.icon(
                            ...
                            label: Text('Quitar de destacados')),
                      ),
