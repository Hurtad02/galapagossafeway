...
class _CitiesPageState extends State<States> {
    ...
    showDialog(
        ...
        builder: (BuildContext context) {
          ...
          children: <Widget>[
            ...
            Text('Quiere borrar este Estado de la base de datos?',
          ...
          children: [
            ...
            Container(
              ...
              child: FlatButton.icon(
                ...
                label: Text('Añadir Estado/División')),
  ...
  handleAddState () async{
    ...
    if(formKey.currentState.validate()){
      ...
      if (ab.userType == 'tester') {
        Navigator.pop(context);
        openDialog(context, 'Eres un Tester', 'Solo los admin pueden agregar contenido');
      } else {
        await getTimestamp()
        .then((value) => addState())
        .then((value) => context.read<AdminBloc>().increaseCount('states_count'))
        .then((value) => openToast1(context, 'Añadido exitosamente'))
        .then((value) => ab.getStates());
        refreshData();
        Navigator.pop(context);
      }
    ...
    showDialog(
      ...
      builder: (context){
        return SimpleDialog(
            ...
            children: <Widget>[
              Text('Añadir Estado/Divisón a la base de datos', style: TextStyle(fontSize: 30, fontWeight: FontWeight.w900),),
              SizedBox(height: 50,),
              Form(
                key: formKey,
                child: Column(children: <Widget>[
                  TextFormField(
                  decoration: inputDecoration('Ingrese nombre del estado', 'Nombre del estado', nameCtrl),
                  controller: nameCtrl,
                  validator: (value) {
                    if (value.isEmpty) return 'El nombre del estado está vacío';
                    return null;
                    },
