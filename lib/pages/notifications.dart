...
class _NotificationsState extends State<Notifications> {
          ...
          children: [
            ...
            Container(
              ...
              child: FlatButton.icon(
                ...
                label: Text('Enviar una notificación')),
  ...
  handleSendNotification () async{
    ...
    if(formKey.currentState.validate()){
      ...
      if (ab.userType == 'tester') {
        Navigator.pop(context);
        openDialog(context, 'Eres un Tester', 'Solo los admin pueden enviar notificaciones');
      } else {
        await getTimestamp()
        ...
        .then((value) => openToast1(context, 'Sent Successfully'));
        refreshData();
        Navigator.pop(context);
      }
    ...
    showDialog(
      ...
      builder: (context){
        return SimpleDialog(
            ...
            children: <Widget>[
              Text('Enviar Push Notification a todos los usuarios', style: TextStyle(fontSize: 30, fontWeight: FontWeight.w900),),
              SizedBox(height: 50,),
              Form(
                key: formKey,
                child: Column(children: <Widget>[
                  TextFormField(
                  decoration: inputDecoration('Ingrese el Título de la notificación', 'Título', titleCtrl),
                  controller: titleCtrl,
                  validator: (value) {
                    if (value.isEmpty) return 'El Título está vacío';
                    return null;
                    },
                  ...
                  decoration: InputDecoration(
                      hintText: 'Ingrese descripción (supports HTML text)',
                  ...
                  validator: (value) {
                    if (value.isEmpty) return 'Descripción está vacía';
                    return null;
                  },
