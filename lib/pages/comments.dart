...
class _CommentsPageState extends State<CommentsPage> {
        ...
        builder: (BuildContext context) {
          return SimpleDialog(
            ...
            children: <Widget>[
              ...
              Text('Quieres borrar este archivo de la base de datos?',
                  style: TextStyle(
                  ...
                  FlatButton(
                    ...
                    onPressed: () async {
                      if (ab.userType == 'tester') {
                        ...
                        openDialog(context, 'Eres un Tester','Solo los admin pueden borrar comentarios');
                      } else {
                        ...
                        .then((value) => openToast1(context, 'Comentario eliminado exitosamente'));
                        reloadData();
                        Navigator.pop(context);
                      }
  ...
  handleSubmit(value) async {
    ...
    if(ab.userType == 'tester'){
      openDialog(context, 'Eres un Tester','Solo los admin pueden hacer comentarios');
    }else{
      if (value.isEmpty) {
      openDialog(context, 'Escribe un comentario!', '');
    } else {
      await context
          .read<CommentBloc>()
          ...
          .then((value) => openToast(context, 'Comentario añadido exitosamente!'));
      clearTextFields();
      reloadData();
    }
    }
